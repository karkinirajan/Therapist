...
export default function ToolsPage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-foreground">CBT Tools &amp; Guidelines</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Framework</h2>
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Cognitive distortions</h2>
        <p className="text-sm text-muted-foreground">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Exposure hierarchy</h2>
        <p className="text-sm text-muted-foreground">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-foreground">Saved thought records &amp; experiments</h2>
        <p className="text-sm text-muted-foreground">
